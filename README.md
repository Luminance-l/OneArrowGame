...
当前结果：10 项测试全部通过。详细记录见 [测试报告](docs/TEST_REPORT.md)。
...
1. 将 [博客草稿](docs/BLOG_DRAFT.md) 顶部的学号、作业链接和 GitHub 链接替换为本人信息。
2. 按本人实际投入时间复核 [PSP 表](docs/PSP.md)。
3. 在 GitHub 新建仓库并推送；仓库内已准备多次有意义的本地 Commit。
