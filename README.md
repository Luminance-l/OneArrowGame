...
![五关通关演示](assets/screenshots/gameplay_demo.gif)
...
- 独创“推理透视”：用绿/红射线解释安全路径和首个阻挡物
- AI 自动求解当前局面，并以提示方式给出下一支安全箭头
- 原创循环轻音乐，以及飞出、点错、失败、通关等独立音效
- 12 个自动化测试覆盖作业 T01–T06、扩展功能和音频资源完整性
- 无外部图片或音频素材，箭头和界面均由 Pygame 矢量绘制
- 可复现的五关通关演示 GIF；每关有独立标题卡、点击前观察停顿和完整结算画面
...
当前结果：12 项测试全部通过。详细记录见 [测试报告](docs/TEST_REPORT.md)。
...
- [x] 课程规定的 T01–T06 与扩展测试共 12 项全部通过
- [x] 5 个关卡均经 BFS 验证，并逐关完成人工试玩
- [x] PSP 已按实际投入复核，AIGC 使用过程与人工修改均已记录
- [x] README、测试报告、五关演示、界面截图和原创音频均已纳入仓库

公开仓库中的 [博客 Markdown 模板](docs/BLOG_DRAFT.md) 有意省略姓名和学号，避免在代码仓库重复公开个人信息；提交到课程平台的博客草稿已填写本人信息。
